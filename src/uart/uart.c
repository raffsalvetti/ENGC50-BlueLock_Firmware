...
#error TX buffer size is not a power of 2
 ...
 #define ATMEGA_USART
 #define UART0_RECEIVE_INTERRUPT   USART_RXC_vect //SIG_UART_RECV modifiquei pois esses vetores foram envenenados
 #define UART0_TRANSMIT_INTERRUPT  USART_UDRE_vect //SIG_UART_DATA  modifiquei pois esses vetores foram envenenados
 #define UART0_STATUS   UCSRA
 #define UART0_CONTROL  UCSRB
 #define UART0_DATA     UDR
 #define UART0_UDRIE    UDRIE
